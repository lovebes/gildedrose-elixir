defmodule GildedRoseTest do
  ...
  describe "backstage passes" do
    ...
    test "should increase in quality as SellIn value approaches, increase by 2 when 10 days or less" do
      start_sell_in = 10
      start_quality = 1
  ...
  describe "conjured" do
    ...
    test "should degrade four times as fast as normal items past sellIn date" do
      start_sell_in = 1
      start_quality = 50
      ...
      assert quality == start_quality - 2 - 4 - 4
    end
  end
end
